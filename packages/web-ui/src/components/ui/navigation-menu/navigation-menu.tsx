...
const navigationMenuTriggerStyle = cva({
  base: "ui-group ui-inline-flex ui-w-max ui-items-center ui-justify-center ui-gap-1 ui-px-5 ui-py-3 ui-text-base ui-font-medium ui-text-white ui-transition-colors hover:ui-bg-red-800 focus:ui-bg-red-800 focus:ui-outline-none disabled:ui-pointer-events-none disabled:ui-opacity-50",
});
...
>(({ className, ...props }, ref) => (
  <div
    className={cn(
      "ui-absolute ui-left-[3.25rem] ui-top-full ui-flex ui-justify-center",
    )}
  >
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="ui-relative ui-top-[60%] ui-h-2 ui-w-2 ui-rotate-45 ui-rounded-tl-sm ui-bg-white ui-shadow-md" />
  </NavigationMenuPrimitive.Indicator>
));
