...
import { getAccountList } from "@repo/shared-logic/apis/base/account/get-account-list";
import {
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
...
const FooterMobileLoggedInSalesRep = async ({
  ...
  const accountListQuery = await getAccountList({
    token,
    baseUrl: process.env.NEXT_PUBLIC_WURTH_LAC_API!,
    apiKey: process.env.NEXT_PUBLIC_WURTH_LAC_API_KEY!,
  });
