...
const NotAvailableInfoBanner = ({
  ...
  return willCallType && willCallType === MAIN_OPTIONS.WILL_CALL_TRANSFER ? (
    <div className="flex flex-col items-center gap-1 rounded-xl bg-red-800/10 px-4 py-2 text-sm">
      <div className="text-red-800">
        ...
        <PlantName plants={plants} plantCode={willCallTransferPlant ?? "N/A"} />
      </div>
    ...
    willCallType && willCallType === MAIN_OPTIONS.WILL_CALL && (
      <div className="flex flex-col items-center gap-1 rounded-xl bg-red-800/10 px-4 py-2 text-sm">
        <div className="text-red-800">
          This item is not available for pickup at{" "}
