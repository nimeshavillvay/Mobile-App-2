...
const CartHeading = ({ token }: CartHeadingProps) => {
  ...
  return (
    <h1 className="container mb-6 mt-4 text-2xl font-light tracking-[-0.144px] text-wurth-gray-800 md:mb-7 md:mt-6 md:text-[40px] md:leading-[3.5rem] md:tracking-[-0.576px]">
