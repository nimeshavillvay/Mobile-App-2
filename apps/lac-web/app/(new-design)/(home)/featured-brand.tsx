  ...
  return (
    ...
    >
      <div className="container">
        <div className="overflow-hidden rounded-lg bg-[#F37021] shadow-lg md:flex md:flex-row-reverse">
          ...
          <div className="p-6 md:flex-1 md:p-12">
            ...
            <h2 className="mb-2 mt-4 font-title text-3xl font-medium tracking-[-0.01406rem] text-white md:mt-14 md:text-5xl md:tracking-[-0.036rem]">
              Moving Ideas
            </h2>
