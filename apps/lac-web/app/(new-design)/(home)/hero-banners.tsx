...
const PlaceholderItem = ({ priority = false }: { priority?: boolean }) => {
  return (
    <CarouselItem>
      <div className="flex h-96 flex-col overflow-hidden rounded-lg bg-[#362A23] shadow-lg md:flex-row-reverse">
        <div className="relative flex-1 bg-red-500 p-5 md:p-9">
          <Image
            src={productImage}
        ...
        <div className="flex flex-1 flex-col justify-between p-5 md:p-9">
          <svg
          ...
          <div className="md:space-y-2">
            <h2 className="font-title text-2xl leading-7 text-[#FFC296] md:line-clamp-2 md:text-[3.25rem] md:leading-[3.5rem]">
              <Balancer>Introducing Revego Pocket Door System</Balancer>
            </h2>

            <p className="text-ellipsis text-sm text-[#FFC296] md:line-clamp-1 md:text-xl">
              <Balancer>
          ...
          <div className="flex flex-row items-end justify-between md:mt-2">
