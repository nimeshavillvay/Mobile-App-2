...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "[&_tr]:border-y-brand-gray-200 bg-brand-gray-100 [&_tr]:border-b-2 [&_tr]:border-t",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "text-brand-gray-500 h-11 text-nowrap px-4 text-left align-middle font-bold [&:has([role=checkbox])]:pr-0",
      className,
    )}
    {...props}
  />
